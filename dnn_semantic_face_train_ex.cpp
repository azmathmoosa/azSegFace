...
int main(int argc, char** argv) try
{
    if (argc != 2)
    {
        cout << "To run this program you need a copy of the SegFace VOC dataset." << endl;
        cout << endl;
        cout << "You call this program like this: " << endl;
        cout << "./dnn_semantic_face_train_ex /path/to/SegFace" << endl;
        return 1;
    }

    cout << "\nSCANNING SegFace VOC DATASET\n" << endl;

    const auto listing = get_pascal_voc2012_train_listing(argv[1]);
    cout << "images in dataset: " << listing.size() << endl;
    if (listing.size() == 0)
    {
        cout << "Didn't find the SegFace dataset. " << endl;
        return 1;
    }
    ...
    trainer.set_synchronization_file("segFace_trainer_state_file.dat", std::chrono::minutes(10));
    ...
    dlib::pipe<training_sample> data(20);
    ...
    serialize("semantic_face_net.dnn") << net;
